...
public class CustomComponentServiceImpl implements CustomComponentService {
    ...
    @Override
    public PageInfo<CustomComponentInfo> getComponentInTrash(Integer userId, Integer type, Integer pageNum, Integer pageSize) {
        PageHelper.startPage(pageNum, pageSize);
        List<CustomComponentInfo> customComponentList = customComponentMapper.selectComponentInTrash(userId, type);
