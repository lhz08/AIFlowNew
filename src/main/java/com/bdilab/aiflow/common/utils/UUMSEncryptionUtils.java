 ...
 * @Version 1.0
 **/
public class UUMSEncryptionUtils {
    /**
...
//        FileInputStream in = new FileInputStream(keystorePath);
        InputStream in = UUMSEncryptionUtils.class.getResourceAsStream(
                keystorePath);
    ...
    public static String decryptLicense(String data,String certificatePath) throws Exception{
        ...
        InputStream resource = UUMSEncryptionUtils.class.getResourceAsStream(certificatePath);
...
//        FileInputStream is = new FileInputStream("");
        ...
        //获取证书实例
        X509Certificate certificate = (X509Certificate) cf.generateCertificate(resource);
